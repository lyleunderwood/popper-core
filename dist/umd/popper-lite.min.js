...
!(function (e, t) {
  ...
  function d(e, t) {
    ...
    var r = n(o);
    return (
      (o = e ? [r].concat(r.visualViewport || [], p(o) ? o : []) : o),
      (t = t.concat(o)),
      e ? t : t.concat(d(u(o)))
    );
  }
    ...
    if (!o)
      e: {
        for (e = u(e); i(e) && 0 > ['html', 'body'].indexOf(a(e)); ) {
          if (
            'none' !== (o = f(e)).transform ||
            'none' !== o.perspective ||
            (o.willChange && 'auto' !== o.willChange)
          ) {
            o = e;
            break e;
          }
  ...
  function y(e, r) {
    if ('viewport' === r) {
      ...
      r &&
        ...
        (e = v((e = { width: p, height: a, x: l + c(e), y: u })));
      ...
      (t =
        'clippingParents' === t
          ? (function (e) {
              var t = d(u(e)),
                o =
                  0 <= ['absolute', 'fixed'].indexOf(f(e).position) && i(e)
                    ? m(e)
                    : e;
              return r(o)
                ? t.filter(function (e) {
                    ...
                    if ((t = r(e)))
                      e: if (
                        ((t = o.getRootNode && o.getRootNode()), e.contains(o))
                      )
                        t = !0;
                      else {
                        var i;
  ...
  function O(e) {
    ...
    if (
      null != (o = o ? (0 <= ['top', 'bottom'].indexOf(o) ? 'x' : 'y') : null)
    )
                ...
                for (
                  ...
                  if (!0 === s.reset) (s.reset = !1), (t = -1);
                    ...
                    (o = void 0 === o ? {} : o),
                      ...
                      'function' == typeof e &&
                        (s =
                          e({ state: s, options: o, name: n, instance: p }) ||
                          s);
                  }
            }
          },
  ...
  function M(e) {
    ...
    if (p) {
      ...
      v === n(o) && (v = s(o)),
        'top' === i &&
          ((g = 'bottom'), (l -= v.clientHeight - r.height), (l *= f ? 1 : -1)),
        'left' === i &&
          ((h = 'right'), (e -= v.clientWidth - r.width), (e *= f ? 1 : -1));
    }
    return (
      (o = Object.assign({ position: c }, p && k)),
      f
        ? Object.assign(
            Object.assign({}, o),
            {},
  ...
  var E = ['top', 'bottom', 'right', 'left'],
    ...
    D = [
      {
        ...
        effect: function (e) {
          ...
          return (
            ...
            a && s.addEventListener('resize', o.update, W),
            function () {
              i &&
                c.forEach(function (e) {
    ...
    R = j({ defaultModifiers: D });
  (e.createPopper = R),
    (e.defaultModifiers = D),
    (e.detectOverflow = function (e, n) {
      void 0 === n && (n = {});
      var o = n;
      ...
      (f = e.rects.popper),
        (a = w(
          r((p = e.elements[p ? ('popper' === i ? 'reference' : 'popper') : i]))
            ? p
        ...
        (f = v(Object.assign(Object.assign({}, f), p))),
        (c = 'popper' === i ? f : c);
      var u = {
